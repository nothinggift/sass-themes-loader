<template>
  <div>
    <md-toolbar>
      <h2 class="md-title" style="flex: 1">sass-themes-loader</h2>
      <a class="md-icon-button" href="https://github.com/nothinggift/sass-themes-loader">
    ...
    <md-tabs @change="removeDefaultTheme">
      <md-tab md-label="themed by sass">
        <themed-by-sass></themed-by-sass>
      </md-tab>
      <md-tab md-label="themed by js">
        <themed-by-js></themed-by-js>
      </md-tab>
    </md-tabs>
  </div>
</template>
